...
public class WeatherApp {
    ...
    /** Runs the weather app. The input determines the UI type. Currently can only handle using the terminal - input "Terminal"*/
    public static void run(String UIType){
        ...
        while (runOrNot){
            ...
            response = getCoords(response, UIHandler, locationSelectionMethod);
    ...
    private static MyContainerClass1 getCoords(MyContainerClass1 toReturn, WeatherAppUIHandler UIHandler, String locationSelectionMethod){
