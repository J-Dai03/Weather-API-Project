...
public class WeatherData {
    ...
    */  
     ...
     * @param FeatureName The key for the feature you want to retrieve
     * @return Returns null for invalid keys, and empty strings for when there is no data for that key.
    */
     ...
     * @param FeatureName The key for the feature you want to remove
    */
